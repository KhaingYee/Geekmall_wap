...
const messages = {
    English: {
      message: {
        ...
        // checkCompanyBankInfor
        opening_name: 'Account opening name',
        account_name: 'Enter your bank account name...',
        bank_account: 'company bank account',
        enter_bank: 'Enter company bank account...',
        opening_branch: 'Account opening branch',
        enter_branch: 'Enter the account opening branch',
        company_weChat: 'WeChat',
        weChat_ID: 'Please enter the WeChat ID',
        Alipay: 'Alipay',
        Alipay_number: 'Please enter your Alipay number',
        registration_code: 'tax registration code',
        registration_number: 'Enter tax registration number',
        certificate_number: 'Electronic version of tax registration certificate number',
        settlement_account: 'Settlement (bank card) account information',
    ...
    Chinese: {
      message: {
        ...
        // checkCompanyBankInfor
        opening_name: '账户开户名',
        account_name: '请输入银行开户名...',
        bank_account: '公司银行账户',
        enter_bank: '请输入公司银行账户...',
        opening_branch: '开户支行',
        enter_branch: '请输入开户支行...',
        company_weChat: '微信',
        weChat_ID: '请输入微信号码',
        Alipay: '支付宝',
        Alipay_number: '请输入支付宝号码',
        registration_code: '税务登记证号',
        registration_number: '请输入税务登记证号',
        certificate_number: '税务登记证号电子版',
        settlement_account: '结算（银行卡）账户信息',
    ...
    Myanmar: {
        message: {
          ...
          // checkCompanyBankInfor
          opening_name: 'အကောင့်ဖွင့်အမည်',
          account_name: 'သင့်ဘဏ်အကောင့်အမည်ကို ထည့်ပါ...',
          bank_account: 'ကုမ္ပဏီဘဏ်အကောင့်',
          enter_bank: 'ကုမ္ပဏီဘဏ်အကောင့်ကို ထည့်ပါ...',
          opening_branch: 'ဘဏ်ခွဲဖွင့်လှစ်ခြင်း',
          enter_branch: 'အကောင့်ဖွင့်တဲ့ဌာနခွဲကိုဝင်ပါ...',
          company_weChat: 'WeChat',
          weChat_ID: 'WeChat ID ကိုထည့်ပါ',
          Alipay: 'Alipay',
          Alipay_number: 'သင်၏ Alipay နံပါတ်ကို ထည့်ပါ',
